# https://github.com/Ryujinx/Ryujinx/blob/master/distribution/macos/bundle_fix_up.py
# Author: Mary Guillemard (https://github.com/marysaka)
# Date: Nov 29, 2022 (https://github.com/Ryujinx/Ryujinx/pull/3934)
# License: MIT License (https://github.com/Ryujinx/Ryujinx/blob/master/LICENSE.txt)
